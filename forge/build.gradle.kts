...
dependencies {
    ...
    modApi("vazkii.patchouli:Patchouli:${project.property("patchouli_version")}-FORGE:api")
    modApi("vazkii.patchouli:Patchouli:${project.property("patchouli_version")}-FORGE")
